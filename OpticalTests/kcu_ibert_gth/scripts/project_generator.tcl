...
if {[string equal $CONFIG TwoQuads]} {
    set TOP_MODULE "kcu_ibert_2quads"
    set IBERT_MODULE "ibert_kcu_2quads"
    set PROJECT_NAME project_2quads
} elseif {[string equal $CONFIG FourQuads]} {
    set TOP_MODULE "kcu_ibert_4quads"
    set IBERT_MODULE "ibert_kcu_4quads"
    set PROJECT_NAME project_4quads
} elseif {[string equal $CONFIG FiveQuads]} {
    set TOP_MODULE "kcu_ibert_5quads"
    set IBERT_MODULE "ibert_kcu_5quads"
    set PROJECT_NAME project_4quads
} elseif {[string equal $CONFIG ThreeQuads]} {
    set TOP_MODULE "kcu_ibert_3quads"
    set IBERT_MODULE "ibert_kcu_3quads"
    set PROJECT_NAME project_4quads
} elseif {[string equal $CONFIG OneQuad]} {
    set TOP_MODULE "kcu_ibert_1quad"
    set IBERT_MODULE "ibert_kcu_1quad"
    set PROJECT_NAME project_1quad
} else {
    set TOP_MODULE "kcu_ucsb_dev"
