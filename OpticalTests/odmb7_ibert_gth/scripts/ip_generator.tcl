if { $argc != 1 } {
  ...
  # Create vio
  create_ip -name vio -vendor xilinx.com -library ip -module_name vio_ibert -dir ../ip/$FPGA_TYPE
  set_property -dict [list CONFIG.C_EN_PROBE_IN_ACTIVITY {1} CONFIG.Component_Name {vio_ibert}] [get_ips vio_ibert]
